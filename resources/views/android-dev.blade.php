...
<head>
<meta charset="utf-8">
<title>BooleanTech | Android Development</title>
<!-- Stylesheets -->
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12 order-2">
                        <div class="service-detail">
                            ...
                            <div class="content-box"> 
                                ...
                                <p>The Boolean Tech is leading mobile app development company in Nigeria, with around 15+ apps in our portfolio working on all OS versions. We have expert team in developing Android apps.</p>
                                <p>We provide high end enhanced Android apps which help clients to enhance their business in various industrial verticals.</p>
                                ...
                                <p>The Boolean Tech follows the rules of SDLC (Software development life cyle) for a perfect approach on project methodology and design.</p>
                                <div class="feature-box row">
                                    ...
                                    <div class="feature-block-two col-xl-6 col-lg-12 col-md-6 col-sm-12 wow fadeInUp">
                                        <div class="inner-box">
                                            ...
                                            <div class="text">Requirement analysis is the foundation of every Android app development team and our team is expert in gathering information requirements in depth.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="feature-block-two col-xl-6 col-lg-12 col-md-6 col-sm-12 wow fadeInUp">
                                        <div class="inner-box">
                                            ...
                                            <h4>VIRTUAL INTERPRETATION</h4>
                                            <div class="text">Secondly, team of creative designers try to build the structure of your ideas in virtual reality as per requirement.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="feature-block-two col-xl-6 col-lg-12 col-md-6 col-sm-12 wow fadeInUp">
                                        <div class="inner-box">
                                            ...
                                            <div class="text">Thirdly, Android app development team applies all functionality to run this bunch of ideas into a real fully equipped Android app.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="feature-block-two col-xl-6 col-lg-12 col-md-6 col-sm-12 wow fadeInUp">
                                        <div class="inner-box">
                                            ...
                                            <h4>QUALITY ASSURANCE & RELEASE</h4>
                                            <div class="text">Lastly, team for testing and QA approves it and furnished app is submitted to the google play store.</div>
                                        </div>
                                    </div>
                                </div>
